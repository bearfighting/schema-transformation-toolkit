...
describe("parser-json inference", () => {
  ...
  describe("field semantics and object merging", () => {
  ...
  describe("mode-driven inference", () => {
      ...
      it('supports numericMode: "number-only" for scalar, object, and array inference', () => {
        ...
        expect(
          ...
          schemaDocument(
            "ObjectNumberOnly",
            schemaObjectNode([
              schemaFieldNode("age", schemaScalarNode("number")),
            ]),
          ),
        );
  ...
  describe("parser interface and options", () => {
