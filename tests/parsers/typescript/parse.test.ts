...
describe("parser-typescript success paths", () => {
  ...
  it("parses array shorthand, direct union roots, and null roots", () => {
    ...
    expect(
      ...
      ok: true,
      document: schemaDocument("ValueDocument", schemaReferenceNode("Value"), {
        definitions: [
          schemaDefinition(
            "Value",
            schemaUnionNode([
        ...
        schemaReferenceNode("Response"),
        {
          definitions: [
            ...
            schemaDefinition(
              ...
              schemaRecordNode(
                schemaScalarNode("string"),
                schemaUnionNode([schemaScalarNode("number"), schemaNullNode()]),
              ),
            ),
            schemaDefinition(
              "Response",
  ...
  it("parses numeric enum declarations with implicit and explicit values", () => {
    expect(
      ...
      ok: true,
      document: schemaDocument("LevelDocument", schemaReferenceNode("Level"), {
        definitions: [
          schemaDefinition(
            "Level",
            schemaUnionNode([
  ...
  it("parses interface declarations as named reusable definitions", () => {
    expect(
      typeScriptParser.parse("interface User { id: number; active: boolean }", {
        entry: "User",
